...
データ全体は調べず，インデックスを使ってデータを効率的に探索する．<br>（探索対象は予めインデックスで纏められているため，その分処理時間が短縮される．）
...
予めすべての列にインデックスを作成したいと思うかもしれないが，この理由でインデックスの更新コストが掛かる．

したがって，<br>
**必要になるリソース・得られる効果を天秤にかけてインデックス作成を心がけること！**
